...
7. Model Training:The model has been compiled using Adam optimizer, a loss function (categorical_crossentropy), and evaluation metrics (e.g., accuracy).Train the model by "fitting" it to the training dataset, using the validation set to check for improvement after each epoch.
