...
7. Model Training:
Compile the model, using Adam optimizer, a loss function (e.g., sparse_categorical_crossentropy or categorical_crossentropy), and evaluation metrics (e.g., accuracy).Train the model by "fitting" it to the training dataset, using the validation set to check for improvement after each epoch.
